<template>
  <div class="user-management">
    ...
    <div v-if="currentView === 'menu'" class="menu-grid">
      <button class="menu-card" @click="showList">
        <span class="icon">📋</span>
        <span class="text">ユーザー一覧表示</span>
      </button>
      <button class="menu-card" @click="showAdd">
        <span class="icon">➕</span>
        <span class="text">ユーザー追加</span>
      </button>
      <button class="menu-card" @click="showDelete">
    ...
    <div v-else-if="currentView === 'delete'" class="user-section">
      ...
      <table class="user-table">
        ...
        <tbody>
          <tr
            v-for="user in paginatedUsersDelete"
            :key="user.uid"
...
const filteredUsersDelete = computed(() => users.value) // 削除画面は検索なしで全ユーザー表示
